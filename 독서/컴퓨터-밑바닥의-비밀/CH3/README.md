...
![메모리 사용 정보 저장](images/pic3_39.png)<br>
...
![힙 영역에서 메모리 할당 요청 추적](images/pic3_41.png)<br>
...
![메모리 조각 끝에 꼬리 정보 추가](images/pic3_55.png)<br>
...
![메모리 할당 한 번에도 운영 체제의 도움이 필요할 수 있다.](images/pic3_67.png)<br><br>
...
프로그램이 메모리를 요청하기만 하고 해제를 하지 않는다면 프로세스의 힙 영역이 점점 늘어나 결국 운영 체제가 강제로 프로세스를 종료하는 상황이 발생한다.<br>
